...
Open the Dashboard: Launch the application in your browser.
Create an Incident: Click on any location on the map to select a point.
Define Details: Choose an incident category and severity, then click “Add Incident”.
Trigger AI Alert: Add multiple high-severity incidents close to each other (within ~300m) to trigger an AI hotspot alert.
Approve Dispatch: Click “Approve Dispatch” to acknowledge the AI recommendation.
Resolve Incidents: Click “Resolve” on incidents to simulate resolution and observe the AI recalculation.
9. Expected Outcomes
